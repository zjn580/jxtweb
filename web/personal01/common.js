	...
	templates: {
		...
		workShowOnline: [
			'<div class="mr_wo_show" data-type="#{type}" data-id="#{id}">',
				...
				'</div>',
			'</div>',
			'<form class="add_worksshow_form addWorksShowOnlineFormUpdate dn">',
				'<div class="mr_add_work mr_addwork_online">',
					...
					'<div class="mr_input_div mr_click_flag">',
					    '<input class="mr_btn workOnlineUrlUpdate" name="url" value="#{href}"/>',
					'</div>',
					'<label>作品描述</label>',
					'<div id="workOnlineDescUpdate" class="wrap_editor">',
						'<script id="ueditor_#{id}" type="text/plain" class="ueditor_updateonlineImage"></script>',
					'</div>',
		...
		workShowUpload: [
			'<div class="mr_wu_show" data-type="#{type}" data-id="#{id}">',
				...
				'</div>',
			'</div>',
			'<form class="add_worksshow_form dn addWorksShowUploadFormUpdate">',
				'<div class="mr_add_work mr_addwork_online">',
					'<div class="mr_worksshow_tab">',
					...
					'<div class="mr_worksshow_upimage">',
						'<div>',
							...
							'<span>上传作品图片</span>',
						'</div>',
						'<input type="file" class="worksshow_up" id="worksshowUpUpdate_#{id}" name="workPic" title="目前仅支持10MB以内的PNG/JPG/JPEG/GIF图片" onchange="myresumeCommon.utils.imageUpload( this, myresumeCommon.requestTargets.workUpload, worksShowOperator.addUploadSucc, worksShowOperator.addUploadFail );" />',
						'<img class="worksshowUpUpdateShow worksshow_img" src="" alt=""/>',
					'</div>',
					'<label>作品标题</label>',
					'<div class="mr_input_div mr_click_flag">',
						'<input class="mr_btn workUploadTitleUpdate" name="workTitle" value="#{title}"/>',
					'</div>',
					'<label>作品描述</label>',
					'<div id="workImagesDescUpdate" class="mr_click_flag wrap_editor">',
						'<script id="ueditor_#{id}" type="text/plain" class="ueditor_updateupdateImage"></script>',
