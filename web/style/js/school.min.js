function img_check(obj, action_url, companyId, id) {
    ...
    this.AllowExt = ".jpg,.gif,.jpeg,.png,.pjpeg",
     this.FileExt= logo.substr(logo.lastIndexOf(".")).toLowerCase(), 0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? errorTips("只支持jpg、gif、png、jpeg格式，请重新上传") : $.ajaxFileUpload({
        url: action_url,
        secureuri: !1,
        fileElementId: id,
        data: {
        ...
        success: function(jsonStr) {
            ...
            result.success ? ($("#logoShow img").attr("src",'./school/'+result.content), $("#logoNo").hide(), $("#logoShow").show()) : $("#logo_error").text(result.msg).show()
        }
    })
}
...
$(function() {
            ...
            submitHandler: function(a) {
                ...
                "" != g && "http://" != g.substring(0, 7) && (g = "http://" + g), h = "请输入创始人个人简介" != $('textarea[name="remark"]', a).val() ? $('textarea[name="remark"]', a).val() : "", i = $(a).parents(".member_wrap"), j = $("#resubmitToken").val(), $(a).find(":submit").attr("disabled", !0), $.ajax({
                    ...
                    $("#resubmitToken").val(b.resubmitToken), b.success ? (
                        $(".member_info:nth-child(1)", i).addClass("dn"),
                         $(".member_info:nth-child(2)", i).addClass("dn"),
                         "" != b.content.weibo ? $(".member_info:nth-child(3) .m_name", i).html(b.content.name + '<a href="' + b.content.weibo ) : $(".member_info:nth-child(3) .m_name", i).html(b.content.name), $(".member_info:nth-child(3) .m_position", i).html(b.content.position), $(".member_info:nth-child(3) .m_intro", i).html(b.content.remark), $(".member_info:nth-child(3)", i).removeClass("dn"), $("#Member .member_wrap").length >= 3 ? $("#Member .c_add").hide() : $("#Member .c_add").hide()) : 1 == $(".member_wrap").length ? ($(".member_info:nth-child(1)", i).removeClass("dn"), $(".member_info:nth-child(2)", i).addClass("dn"), $(".member_info:nth-child(2) input[type!='submit'], .member_info:nth-child(2) textarea", i).val(""), $(".member_info:nth-child(3)", i).addClass("dn"), $("#Member .c_add").hide()) : ($(i).remove(), $("#Member .c_add").show()),
    ...
    $("#Product").on("click", ".product_delete", function() {
        var a, b;
        confirm("确定要删除该条产？") && (a = $(this).next().val(), b = $(this).parents(".product_wrap"), "" == a ? $("#Product .product_wrap").length <= 1 ? ($("dl:nth-child(2) input[type!='submit']").val(), $("dl:nth-child(1)", b).removeClass("dn"), $("dl:nth-child(2)", b).addClass("dn"), $("dl:nth-child(2) input[type!='submit'], dl:nth-child(2) textarea", b).val(""), $("dl:nth-child(3)", b).addClass("dn")) : $(b).remove() : $.ajax({
            type: "POST",
        ...
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                "" != f && "http://" != f.substring(0, 7) && (f = "http://" + f), g = "请分段详细描述公司简介、企业文化等" != $('textarea[name="productProfile"]', a).val() ? $('textarea[name="productProfile"]', a).val() : "", h = $("#resubmitToken").val(), i = $(a).parents(".product_wrap"), $(a).find(":submit").attr("disabled", !0), $.ajax({
                    ...
                    alert(b);exit;
                    $("#resubmit Token").val(b.resubmitToken), b.success ? ($("dl:nth-child(1)", i).addClass("dn"), $("dl:nth-child(2)", i).addClass("dn"), $("dl:nth-child(2) .product_id", i).val(b.content.id), $("dl:nth-child(3) img", i).attr("src", ctx + "/" + b.content.productPicUrl), $("dl:nth-child(3) .cp_intro a", i).attr("href", b.content.productUrl), $("dl:nth-child(3) .cp_intro a", i).html(b.content.product), $("dl:nth-child(3) .jspPane > div", i).html(b.content.productProfile), $("dl:nth-child(2) textarea", i).text(b.content.productProfile), $("dl:nth-child(3)", i).removeClass("dn"), $(".scroll-pane").jScrollPane()) : 1 == $(".product_wrap").length ? ($("dl:nth-child(1)", i).removeClass("dn"), $("dl:nth-child(2)", i).addClass("dn"), $("dl:nth-child(2) input[type!='submit'], dl:nth-child(2) textarea", i).val(""), $("dl:nth-child(2) textarea", i).text(""), $("dl:nth-child(3)", i).addClass("dn")) : $(i).remove(), $(a).find(":submit").attr("disabled", !1)
                })
            }
        })
    }), 
    ...
    $("#editDetailForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $(a).find(":submit").attr("disabled", !0), $.ajax({
                ...
                //alert(b);exit;
                if (b.success) if ("" == b.content) $("dl:nth-child(1)", d).show(), $("dl:nth-child(2) textarea", d).val(""), $("dl:nth-child(2)", d).hide(), $("dl:nth-child(3) .c_intro", d).html(""), $("dl:nth-child(3)", d).hide();
                else {
