...
<input type="hidden" value="4" name="status">
   <div class="content"> 
    <dl class="company_center_content"> 
     <dt> 
      <h1> <em></em> 自动过滤简历 <span>（共1份）</span> </h1> 
     </dt> 
     <dd> 
      <form action="autoFilterResumes.html" method="get" id="filterForm"> 
       <div class="filter_tip">
        ...
        <span>15</span> 日内未作处理，拉勾将自动发送拒绝邮件至用户邮箱。 
       </div> 
       ...
       <ul class="reset resumeLists"> 
          ...
          <li class="onlineResume"> <label class="checkbox"> <input type="checkbox" /> <i></i> </label> 
           <div class="resumeShow"> 
            ...
            <div class="links"> 
             <a data-deliverid="<?=$v['pe_id']?>" data-name="jason" data-positionid="<?=$v['p_id']?>" data-email="<?=$v['email']?>" class="resume_notice" href="javascript:void(0)">通知面试</a> 
             <a data-deliverid="<?=$v['pe_id']?>" class="resume_refuse" href="javascript:void(0)">不合适</a> 
             <a data-deliverid="<?=$v['pe_id']?>" class="resume_caninterview" href="javascript:void(0)">待定</a> 
             <a data-resumename="jason的简历" data-positionname="随便写" data-deliverid="<?=$v['pe_id']?>" data-positionid="<?=$v['p_id']?>" data-resumekey="1ccca806e13637f7b1a4560f80f08057" data-forwardcount="1" class="resume_forward" href="javascript:void(0)"> 转发 <span>(1人)</span> </a>
            </div> 
           </div> 
         </li> 
       <?php }?>
