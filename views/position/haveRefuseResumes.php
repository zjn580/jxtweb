  ...
  <?= $this->render('left') ?>
   <div class="content"> 
    <dl class="company_center_content"> 
     <dt> 
      <h1> <em></em> 不合适简历 <span>（共1份）</span> </h1> 
     </dt> 
     <dd> 
         ...
         <?php foreach ($arr as $k => $v) {?>
          <li data-id ='<?=$v['po_id']?>' class="onlineResume"> <label class="checkbox"> <input type="checkbox" /> <i></i> </label> 
           <div class="resumeShow"> 
            ...
            <div class="links"> 
              <a data-resumename="jason的简历" data-positionname="随便写" data-deliverid="<?=$v['po_id']?>" data-positionid="<?=$v['p_id']?>" data-forwardcount="1" class="resume_forward" href="javascript:void(0)"> 转发 <span>(1人)</span> </a> 
