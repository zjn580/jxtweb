...
<div class="login_wrapper">
    ...
    <div class="login_box">
        <form id="loginForm" action="?r=login/deng" method="post">
            ...
            <label class="fl" for="remember">
                <input type="checkbox" id="remember" value="7" checked="checked" name="autoLogin" />
                记住我
            </label>
            <a href="?r=login/retrieve" class="fr" target="_blank">忘记密码？</a>

             <input type="submit" id="submitLogin" value="登 &nbsp; &nbsp; 录" />

            <!-- <a style="color:#fff;" href="?r=login/deng" class="submitLogin" title="登 &nbsp; &nbsp; 录"/>登 &nbsp; &nbsp; 录</a>-->
