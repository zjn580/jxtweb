...
<div id="container">
    ...
    <div class="content_mid">
        <dl class="c_section c_section_mid">
            <dt>
            <h2><em></em>填写机构信息</h2>
            <a class="c_addjob" href="?r=school/add_member"><i></i>发布新职位</a>
            </dt>
            <dd id="step2Form">
                <div class="c_text">简短明了的标签信息让公司更加方便检索，更快找到你们！</div>
                ...
                <a class="btn_cancel fr" href="?r=school/info03">跳过</a>

            </dd>
        </dl>
    </div>

    <script src="style/js/schoolstep2.min.js" type="text/javascript"></script>
    <div class="clear"></div>
