        	...
        	<dl class="c_section c_section_mid">
                ...
                <dd class="c_certify"> 
                    ...
                    <ul class="c_certify_list">
                    	<li class="list1">机构主页<span>[ 网站处于正常运行状态，且必须具有备案号 ]</span></li>
                        <li class="list2">机构名称<span>[ 简称应为企业/产品简称，不可使用简易修饰性词语 ]</span></li>
                        <li class="list3">机构logo<span>[ 必须真实有效的体现机构形象 ]</span></li>
                        <li class="list4">
                        	机构的营业执照
