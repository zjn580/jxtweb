            ...
            <div class="c_detail">
                <div style="background-color:#fff;" class="c_logo">
                    <a title="公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader">
                        <img width="190" height="190" alt="公司logo" src="./company/<?php echo $company['c_logo'];?>">

                        <span>公司图片<br>190px*190px 小于5M</span>
                    </a>
                </div>

                <div class="c_logo" style="background-color:#fff;">
                    <div id="logoShow">
                        <img src="./company/<?php echo $company['c_logo'];?>" width="190" height="190" alt="公司logo" />
                        <span>公司图片<br />190px*190px 小于5M</span>
                    </div>
                    ...
                    <dl class="c_section newIntro dn">
                        ...
                        <dd>
                            <form id="companyDesForm">
                                <textarea placeholder="请分段详细描述公司简介、企业文化等" name="companyProfile" id="companyProfile"><?php echo $company['c_intro'];?></textarea>
                ...
                <div id="c_tags_show" class="c_tags solveWrap">
                    <table>
                        ...
                        <tr>
                            <td>主页</td>
                            <td>
                                <a rel="nofollow" title="http://www.weimob.com" target="_blank" href="http://www.weimob.com"><?php echo $company['c_website'];?></a>
                            </td>
                        </tr>
                        </tbody></table>
